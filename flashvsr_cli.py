...
_wanvsr_dir = os.path.join(_script_dir, 'examples', 'WanVSR')
if os.path.exists(_wanvsr_dir):
    sys.path.insert(0, _wanvsr_dir)
else:
    # Try relative to current working directory
    _wanvsr_dir = os.path.join(os.getcwd(), 'examples', 'WanVSR')
    if os.path.exists(_wanvsr_dir):
        sys.path.insert(0, _wanvsr_dir)

from diffsynth import ModelManager, FlashVSRFullPipeline, FlashVSRTinyPipeline, FlashVSRTinyLongPipeline
from utils.utils import Causal_LQ4x_Proj, Buffer_LQ4x_Proj
