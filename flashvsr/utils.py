...
# -*- coding: utf-8 -*-
"""
Utility helpers for FlashVSR data handling.

These functions are shared between the library and the CLI, covering
tensor/image conversions, natural sorting, and input preparation.
"""
...
def natural_key(name: str):
    ...
    for t in name_parts:
        if t:
            key.append((1, int(t)) if t.isdigit() else (0, t))
